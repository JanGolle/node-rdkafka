...
__This library currently uses `librdkafka` version `1.0.0-RC5`.__
...
You can pass many configuration options to `librdkafka`.  A full list can be found in `librdkafka`'s [Configuration.md](https://github.com/edenhill/librdkafka/blob/v1.0.0-RC5/CONFIGURATION.md)
